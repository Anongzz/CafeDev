...
public class doc1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (url.contains("order.mvc")) {
			...
			// System.out.println("order_edit.mvc 가 요청함");
			String str1 = request.getParameter("data1");
			...
			request.setAttribute("result", result);
			viewName = "order_edit.jsp";
		} else if(url.contains("order_count.mvc")) {
			//System.out.println("order_count.mvc 가 요청함");
			String str1 = request.getParameter("data1");
			String str2 = request.getParameter("data2");
			
			HttpSession session = request.getSession();
			session.setAttribute("drinkName", str1);
			session.setAttribute("drinkPrice", str2);
			viewName = "order_count.jsp";
		}
