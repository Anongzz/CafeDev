	...
	<div class="mainArea">
		...
		<div class="categoryArea">
			<input type="button" value="커피"
				onclick="location.href='order_edit.mvc?data1=coffee'"> <input
				type="button" value="에이드"
				onclick="location.href='order_edit.mvc?data1=ade'"> <input
				type="button" value="라떼"
				onclick="location.href='order_edit.mvc?data1=smoothie'"> <input
				type="button" value="스무디"
				onclick="location.href='order_edit.mvc?data1=latte'">
		</div>
		<div class="orderContent">
			...
			<div class="drinkList">
				<div style="text-align: center; cursor: pointer;">
					<img alt="add_building" src="images/<%=drinkIMG%>" width="100"
						height="100" onclick="sessionStorage.setItem('drink', '<%=drinkName %>')"> <br>
					<b><%=drinkName%></b> <br>
					<b><%=drinkPrice%>원</b>
				</div>
		...
		<div class="orderSummit">
			...
			<br> <a href="index.html" style="position: absolute; left: 40%;">뒤로가기</a>
		</div>
	</div>
</body>
</html>